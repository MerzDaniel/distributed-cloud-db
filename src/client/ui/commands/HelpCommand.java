...
public class HelpCommand implements Command {
    ...
    public void execute(ApplicationState state) {
        ...
        writeLine("queryByUser <userId> <property1>,<property2>, ...         " +
                                        ": Get the result <property1>, <property2>, ... for User of <userId>");
        writeLine("queryByMessage <messageId> <property1>,<property2>, ...         " +
                ": Get the result <property1>, <property2>, ... for Message of <messageId>");
        writeLine("query <query>         : Get the result for <query> from the data store");
